...
<html>
	...
	<body id="apple-pd">
		<div id="navbox" class="gradient">
			<div id="navleftbox">
				<a class="navlink_left" href="help:anchor='access' bookID=com.fruitz-of-dojo.Quake.help">Home</a></div>
			<div id="navrightbox">
				<a class="navlink_right" href="help:anchor='xall' bookID=com.fruitz-of-dojo.Quake.help">Index</a></div>
		</div>
		<div id="list">
