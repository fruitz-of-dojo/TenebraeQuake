...
for (surfcount = 0; surfcount < pinmodel->numSurfaces; ++surfcount) {
	...
	pheader->posedata = (int)((byte *)verts - (byte *)pheader);
	xyz = (md3XyzNormal_t *) ( (byte *)surf + surf->ofsXyzNormals );
	...
	pheader->triangles = (int)((byte *)tris - (byte *)pheader);
	tri = (md3Triangle_t *) ( (byte *)surf + surf->ofsTriangles );
	...
	pheader->planes = (int)((byte *)norms - (byte *)pheader);
	...
	pheader->texcoords = (int)((byte *)texcoords - (byte *)pheader);
	st = (md3St_t *) ( (byte *)surf + surf->ofsSt );
	...
	pheader->indecies = (int)((byte *)indecies - (byte *)pheader);
	for (i=0 ; i<pheader->numtris ; i++) {
		for (j=0 ; j<3 ; j++) {
	...
	pheader->tangents = (int)((byte *)tangents - (byte *)pheader);
