...
#if !defined (GL_PN_TRIANGLES_ATI) || defined (__APPLE__) || defined (MACOSX)
...
#if !defined (GL_ATI_vertex_streams) || defined (__APPLE__) || defined (MACOSX)
...
#if !defined (GL_ATI_vertex_array_object) || defined (__APPLE__) || defined (MACOSX)
...
#if !defined (GL_ATI_map_object_buffer) || defined (__APPLE__) || defined (MACOSX)
