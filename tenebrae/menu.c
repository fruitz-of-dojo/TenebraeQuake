...
#if defined (__APPLE__) || defined (MACOSX)
    M_Print (16, 176, "            Use Rumble");
    M_DrawCheckbox (220, 176, in_actuators.value);
#endif /* __APPLE__ ||MACOSX */
...
void M_Quit_Draw (void)
{
// <AWE> only required for the Windows version.
#ifdef _WIN32
	char str[64];
#endif /* _WIN32 */
	...
	/*
	sprintf(str, "  Tenebrae version %4.2f (win32)\n", STQUAKE_VERSION);
	M_PrintWhite (16, 12,str);
	M_PrintWhite (16, 28, "Code Modifications \n");
	...
	*/
	M_PrintWhite (16, 108, "Based on the Quake source\n");
	M_PrintWhite (16, 116, "   by ID-Software\n");
	/*
	M_PrintWhite (16, 124, "Sound Effects\n");
	*/
	M_PrintWhite (16, 132, "Website:\n");
	M_Print      (16, 140, " http://tenebrae.sourceforge.net\n");
	/*
